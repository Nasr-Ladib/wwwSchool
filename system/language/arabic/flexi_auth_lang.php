...
*
* Description:
* Arab language file for Flexi Auth
*
* Requirements: PHP5 and Codeigniter 3.0+
*/

// Account Creation
$lang['account_creation_successful']					= 'غير قادر على إيجاد إعدادات الإتصال بقواعد البيانات بناء على البيانات المرسلة';
$lang['account_creation_unsuccessful']					= 'غير قادر على إيجاد إعدادات الإتصال بقواعد البيانات بناء على البيانات المرسلة';
$lang['account_creation_duplicate_email']			= 'غير قادر على إيجاد إعدادات الإتصال بقواعد البيانات بناء على البيانات المرسلة';
$lang['account_creation_duplicate_username']		= 'غير قادر على إيجاد إعدادات الإتصال بقواعد البيانات بناء على البيانات المرسلة';
$lang['account_creation_duplicate_identity'] 		= 'غير قادر على إيجاد إعدادات الإتصال بقواعد البيانات بناء على البيانات المرسلة';
$lang['account_creation_insufficient_data']			= 'غير قادر على إيجاد إعدادات الإتصال بقواعد البيانات بناء على البيانات المرسلة';

// Password
$lang['password_invalid']										= 'غير قادر على إيجاد إعدادات الإتصال بقواعد البيانات بناء على البيانات المرسلة';
$lang['password_change_successful'] 	 	 			= 'غير قادر على إيجاد إعدادات الإتصال بقواعد البيانات بناء على البيانات المرسلة';
