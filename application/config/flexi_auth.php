...
$config['database']['custom']['teacher']['table'] = 'teacher';
$config['database']['custom']['teacher']['primary_key'] = 'id';
$config['database']['custom']['teacher']['foreign_key'] = 'uacc_ID';
$config['database']['custom']['teacher']['join'] = 'teacher.uacc_ID';
$config['database']['custom']['teacher']['custom_columns'] = array(
    'name'
);
...
// Site title shown as 'from' header on emails.
	$config['email']['site_title'] = "School";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "contact@brain-soft-tn.com";
