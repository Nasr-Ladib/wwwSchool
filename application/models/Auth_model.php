...
class Auth_model extends CI_Model {
	...
	function register_account($instant_activate = FALSE, $user_group = FALSE, $redirect = TRUE)
	{
		...
		$validation_rules = array(
			array('field' => 'register_first_name', 'rules' => 'required'),
			array('field' => 'register_last_name', 'rules' => 'required'),
			array('field' => 'register_email_address', 'rules' => 'required|valid_email|identity_available'),
			array('field' => 'register_username', 'rules' => 'required|min_length[4]|identity_available'),
            array('field' => 'register_password', 'rules' => 'required|validate_password'),
			array('field' => 'register_confirm_password', 'rules' => 'required|matches[register_password]')
		);
