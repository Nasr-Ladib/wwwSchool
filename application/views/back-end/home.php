            ...
            <section class="col-lg-7 connectedSortable">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body chat" id="chat-box">
                        <!-- chat item -->
                        <div class="item">
                            <img src="dist/img/profile.png" alt="user image" class="online">
                            <p class="message">
                                <a href="#" class="name">
                        ...
                        <!-- chat item -->
                        <div class="item">
                            <img src="dist/img/profile.png" alt="user image" class="offline">
                            <p class="message">
                                <a href="#" class="name">
            ...
            <section class="col-lg-5 connectedSortable">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-footer clearfix no-border">
                        <button class="btn btn-default pull-left"><a href="Form.html" style="color:#000"><i class="fa fa-plus"></i> إضافة إعلان</a></button>
                    </div>
                </div><!-- /.box -->
