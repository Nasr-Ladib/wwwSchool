                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php foreach($exercices as $exercice){?>
                        <tr id="<?php echo $exercice['id'] ?>">
                            ...
                            <td><?php if(($exercice['Response1'])||($exercice['Response2'])||($exercice['Response3'])){ ?>
                            <div class="col-lg-6">
                                <?php if($exercice['Response1']){ ?>
                                    <audio controls>
                                        <source src="<?php echo base_url('assets/uploads/'.$exercice['Response1']) ?>" type="audio/3gp">
                                    </audio>
                                <?php } ?>
                                <?php if($exercice['Response2']){ ?>
                                    <audio controls>
                                        <source src="<?php echo base_url('assets/uploads/'.$exercice['Response1']) ?>" type="audio/3gp">
                                    </audio>
                                <?php } ?>
                                <?php if($exercice['Response3']){ ?>
                                    <audio controls>
                                        <source src="<?php echo base_url('assets/uploads/'.$exercice['Response1']) ?>" type="audio/3gp">
                                    </audio>
                                <?php } ?></div>
