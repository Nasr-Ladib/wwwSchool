                    ...
                    <?php foreach($students as $student){?>
                        <tr id="<?php echo $student['id'] ?>">
                            <td>
                                ...
                                <i class="fa fa-trash-o" id="delete<?php echo $student['id']  ?>" onclick="deleteClass(<?php echo $student['id']?>,'<?php echo $student['classe']?>' )" onmouseenter="document.getElementById('delete<?php echo $student['id'] ?>').style.color = 'red';" onmouseleave="document.getElementById('delete<?php echo $student['id']  ?>').style.color = 'black';"></i>
                            ...
                            <script>
                                ...
                                function deleteClass(id,classe) {
                                    alert('حذف هذا تلميذ من قائمتك ');
                                    $.ajax({
