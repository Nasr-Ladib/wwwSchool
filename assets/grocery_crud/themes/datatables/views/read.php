		...
		?>
			<div class='form-field-box <?php echo $even_odd?>' id="<?php echo $field->field_name; ?>_field_box">
				...
				<div class='form-input-box' id="<?php echo $field->field_name; ?>_input_box">
                    <?php if($input_fields[$field->field_name]->display_as=='Pub Photo')

                      echo '<img src="http://localhost/codeigniter/assets/uploads/iphone-6s-gris-sideral-vue-1-35311.jpg" target="_blank">'
                   ?>
